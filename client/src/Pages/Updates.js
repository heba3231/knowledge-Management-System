...
const UpdateWorkshop = () => {
  ...
  const [formData, setFormData] = useState({
    title: '',
    description: '',
    images: [],          // الملفات الجديدة (للرفع)
    videos: [],          // الملفات الجديدة (للرفع)
    existingImages: [],  // الروابط الحالية
    existingVideos: [],  // الروابط الحالية
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // إرسال قوائم الملفات الحالية بعد التعديل (للحذف أو الاحتفاظ)
  ...
  return (
    <div style={styles.container}>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        {/* إضافة فيديوهات جديدة مع عرض الأسماء */}
        <div style={styles.field}>
