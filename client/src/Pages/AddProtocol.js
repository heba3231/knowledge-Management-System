// client/src/Pages/AddProtocol.js
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setError(response.data.message || 'فشل في إضافة البروتوكول');
      }
    } catch (err) {
      console.error('Add protocol error:', err);
      setError('فشل إضافة البروتوكول. حاول مرة أخرى.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.pageTitle}>📜 إضافة بروتوكول جديد</h1>
        <p style={styles.pageSubtitle}>أضف بروتوكولاً جديداً لأحد الأقسام</p>
      </div>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        <div style={styles.field}>
          ...
          <input
            type="text"
            name="title"
            placeholder="أدخل عنوان البروتوكول"
        ...
        <div style={styles.field}>
          ...
          <textarea
            name="description"
            placeholder="وصف مختصر للبروتوكول"
        ...
        <div style={styles.buttons}>
          ...
          >
            {loading ? 'جاري الإضافة...' : '📤 إضافة البروتوكول'}
          </button>
          <button
            type="button"
